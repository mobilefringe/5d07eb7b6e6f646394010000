            ...
            methods: {
                loadData: async function(id) {
                    try {
                        ...
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/sevenoaks-guest-services".json"}),this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {
