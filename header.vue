    						...
    						<nav id="mobile_nav" v-show="show_mobile_menu">
    							<ul>
    								<div class="mobile_menu_site_logo">
    									<router-link to="/">
    									    <img v-if="property" src="//codecloud.cdn.speedyrails.net/sites/5d07eb7b6e6f646394010000/image/png/1564167641000/SevenOaksBlack.png" :alt="property.name +' Mobile Logo'"/>
									    </router-link>
    								</div>
