		...
		<div class="map_container site_container clearfix">
			<div class="col-sm-4">
                <div class="map_directory text-center hidden_phone">
                    <h2 style="display:none;" class="map_title caps">Find a Store</h2>
                    <h3 class="map_title caps">Find a Store</h3>
                ...
                <div class="visible_phone">
					...
					<div class="alphabet-dd visible_phone" >
					    <v-select :options="allStores" label="name" :searchable="false" :on-change="dropPin" id="mobile_alpha_list" placeholder="Select a Store"></v-select>
				    </div>
                </div>
            </div>
            <div class="col-sm-8">
